...
PACKAGES+=" python-distutils-extra python-httplib2"
PACKAGES+=" libxss-dev"
...
PACKAGES+=" librsvg2-dev libtagc0-dev"
...
PACKAGES+=" python-pip python-dogtail python-psutil gdb valgrind tmuxinator tmux ltrace"

PACKAGES+=" python-ldtp ldtp python-wheel python-setuptools"
